...
python %playgame% --verbose -e --scenario --food none --player_seed 42 --turntime 30000 --end_wait=0 --log_dir %~dp0bots\game_logs --turns 500 --map_file %map% %* %player1% %player2% 
::--scenario --food none
