...
public class SampleTreeFactory {
         ...
         */
	public static DefaultTreeForTreeLayout<TextInBox> myTree;
        ...
        public static DefaultTreeForTreeLayout getTree(TextInBox t){
        	return new DefaultTreeForTreeLayout<TextInBox>(
                    t);
        }
